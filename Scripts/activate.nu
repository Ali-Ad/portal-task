...
let virtual-env = "C:\Users\Trainee\Envs\wagtaill"
let bin = "Scripts"
let path-sep = ";"
...
let virtual_prompt = (if ("wagtaill" != "") {
    "(wagtaill) "
} {
...
alias deactivate = source "C:\Users\Trainee\Envs\wagtaill\Scripts\deactivate.nu"
