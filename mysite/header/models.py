...
class HeaderPageCarouse(Orderable):
    ...
    internal_url = models.ForeignKey("wagtailcore.Page",null=True,blank=True,on_delete=models.CASCADE,related_name="+")
    external_url = models.URLField(blank=True, null=True)

    # Panels = [
    #     StreamFieldPanel("sub_title"),
    #     StreamFieldPanel("ppp"),
    # ]
